...
$(package)_linux_dependencies=freetype fontconfig libxcb libxkbcommon libxcb_util libxcb_util_render libxcb_util_keysyms libxcb_util_image libxcb_util_wm libX11 xproto libXext
...
define $(package)_extract_cmds
  ...
  sha256sum -c $($(package)_extract_dir)/.$($(package)_file_name).hash && \
  mkdir qtbase && \
