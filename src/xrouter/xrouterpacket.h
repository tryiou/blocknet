...
#ifndef BLOCKNET_XROUTER_XROUTERPACKET_H
...
inline std::string XRouterCommand_ToString(enum XRouterCommand c)
{
    switch (c)
    {
        ...
        default: return strprintf("[Unknown XRouterCommand] %u", c);
    }
};
...
#endif // BLOCKNET_XROUTER_XROUTERPACKET_H
