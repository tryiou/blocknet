...
class BlocknetGUI : public BitcoinGUIObj {
    Q_OBJECT
public:
    explicit BlocknetGUI(interfaces::Node& node, const PlatformStyle *platformStyle,
...
private:
    QAction *openCoinControlAction = nullptr;

/// Everything below this line is from BitcoinGUI
public:
...
protected:
    ...
    BlocknetWallet* walletFrame = nullptr;
