...
((gnu packages python) #:select (python-minimal python))
...
(define-public python-lief
  (package
    ...
    (native-inputs (list cmake-minimal python python-tomli pkg-config))
    (arguments
     (list
...
;; glibc floor raised to 2.35 (stock glibc at this Guix pin) — no custom 2.27
;; For reference, previous custom 2.27 with 5 patches removed for cleanliness.
;; Stock glibc provides 2.35, compatible with ubuntu:22.04 runtime.
